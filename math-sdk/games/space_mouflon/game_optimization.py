...
NOTE: These are Phase 3 scaffold values so the config is structurally valid
and importable. Exact RTP-per-criteria splits, scaling curves and search
parameters are Phase 4 work, tuned with the Rust optimization program to hit
96.5% RTP / high volatility / 20,000x cap.
"""
        ...
        self.game_config.opt_params = {
            "base": {
                "conditions": {
                    ...
                    "freegame": ConstructConditions(
                        rtp=0.664, hr=200, search_conditions={"symbol": "scatter"}
                    ).return_dict(),
                    "basegame": ConstructConditions(hr=3.5, rtp=0.30).return_dict(),
                },
            ...
            "ante": {
                "conditions": {
                    ...
                    "0": ConstructConditions(rtp=0, av_win=0, search_conditions=0).return_dict(),
                    "freegame": ConstructConditions(
                        rtp=0.700, hr=100, search_conditions={"symbol": "scatter"}
                    ).return_dict(),
                    "basegame": ConstructConditions(hr=3.5, rtp=0.264).return_dict(),
                },
                "scaling": ConstructScaling(
                    [
                        {"criteria": "basegame", "scale_factor": 1.2, "win_range": (1, 2), "probability": 1.0},
            ...
            "bonus": {
                "conditions": {
                    "wincap": ConstructConditions(rtp=0.001, av_win=wincap, search_conditions=wincap).return_dict(),
                    "freegame": ConstructConditions(rtp=0.964, hr="x").return_dict(),
                },
                "scaling": ConstructScaling(
                    [
                        {"criteria": "freegame", "scale_factor": 1.2, "win_range": (3000, 4000), "probability": 1.0},
